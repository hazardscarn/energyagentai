...
class vizConfig:
    ...
    default_model: str = "gemini-2.5-flash"  # For faster operation
    primary_model: str = "gemini-2.5-pro"  # For complex reasoning
    viz_code_model : str = "gemini-2.5-flash"  # For faster operation  
